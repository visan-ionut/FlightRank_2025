...
initial_feature = FeatureSpec(
    ...
    categorical_features=[
        ...
        # "legs0_segments0_flightNumber_digit1",
        # "legs0_segments0_flightNumber_digit10",
        # "legs0_segments0_flightNumber_digit100",
        # "legs0_segments0_flightNumber_digit1000",
        # "legs1_segments0_flightNumber_digit1",
        # "legs1_segments0_flightNumber_digit10",
        # "legs1_segments0_flightNumber_digit100",
        # "legs1_segments0_flightNumber_digit1000",
    ],
    exclude_features=[
        "group_size",
        "price_per_tax",
...
aircraft_feature = FeatureSpec(
    name="aircraft",
    categorical_features=[
        "legs0_segments0_aircraft_code_type",
        "legs0_segments0_aircraft_code_size",
        # "legs0_segments0_aircraft_code_engine",
        "legs0_segments0_aircraft_code_seating_class",
        "legs0_segments0_aircraft_code_range_class",
        "legs1_segments0_aircraft_code_type",
        "legs1_segments0_aircraft_code_size",
        # "legs1_segments0_aircraft_code_engine",
        "legs1_segments0_aircraft_code_seating_class",
        "legs1_segments0_aircraft_code_range_class",
    ],
    numerical_features=[],
    exclude_features=[
        "legs0_segments0_aircraft_code_engine",
...
combined_feature = FeatureSpec(
    name="combined",
    numerical_features=[
        # outbound_carrier_route
        "outbound_carrier_route_totalPrice_mean",
        # "outbound_carrier_route_totalPrice_std",
        "outbound_carrier_route_totalPrice_min",
        "outbound_carrier_route_totalPrice_max",
        # "outbound_carrier_route_totalPrice_median",
        "outbound_carrier_route_legs0_duration_mean",
        # "outbound_carrier_route_legs0_duration_std",
        "outbound_carrier_route_legs0_duration_min",
        "outbound_carrier_route_legs0_duration_max",
        "outbound_carrier_route_legs0_duration_median",
        # return_carrier_route
        "return_carrier_route_totalPrice_mean",
        # "return_carrier_route_totalPrice_std",
        "return_carrier_route_totalPrice_min",
        "return_carrier_route_totalPrice_max",
        "return_carrier_route_totalPrice_median",
        "return_carrier_route_legs1_duration_mean",
        # "return_carrier_route_legs1_duration_std",
        "return_carrier_route_legs1_duration_min",
        "return_carrier_route_legs1_duration_max",
        "return_carrier_route_legs1_duration_median",
        # legs0_carrier_segments
        "legs0_carrier_segments_totalPrice_mean",
        # "legs0_carrier_segments_totalPrice_std",
        "legs0_carrier_segments_totalPrice_min",
        "legs0_carrier_segments_totalPrice_max",
        "legs0_carrier_segments_totalPrice_median",
        "legs0_carrier_segments_legs0_duration_mean",
        # "legs0_carrier_segments_legs0_duration_std",
        "legs0_carrier_segments_legs0_duration_min",
        "legs0_carrier_segments_legs0_duration_max",
        "legs0_carrier_segments_legs0_duration_median",
        # legs1_carrier_segments
        "legs1_carrier_segments_totalPrice_mean",
        # "legs1_carrier_segments_totalPrice_std",
        "legs1_carrier_segments_totalPrice_min",
        "legs1_carrier_segments_totalPrice_max",
        "legs1_carrier_segments_totalPrice_median",
        "legs1_carrier_segments_legs1_duration_mean",
        # "legs1_carrier_segments_legs1_duration_std",
        "legs1_carrier_segments_legs1_duration_min",
        "legs1_carrier_segments_legs1_duration_max",
        "legs1_carrier_segments_legs1_duration_median",
    ],
    categorical_features=[
        "outbound_carrier_route",
        "return_carrier_route",
